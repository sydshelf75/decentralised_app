            ...
            return (
              <Link
                ...
                className={`flex items-center gap-4 px-4 py-3 rounded-lg transition-all ${
                  item.active
                    ? "text-white bg-gradient-to-r from-indigo-600/50 to-purple-600/30 border border-indigo-500/30"
          ...
          <div className="flex flex-col gap-2">
            {knowledgeCategories.map((category) => (
              <Link
                key={category.name}
                href="#"
                className="flex items-center gap-3 px-4 py-2 text-gray-400 hover:text-white rounded-lg transition-colors group"
              >
